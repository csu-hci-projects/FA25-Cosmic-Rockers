...
func _ready() -> void:
	super()
	if PlayerState.get_player_data(int(player_owner.entity_id)).has("player_customization"):
		var player_data = PlayerState.get_player_data(int(player_owner.entity_id))["player_customization"]
